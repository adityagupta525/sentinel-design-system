...
| **36 component spec pages** | Specimen, anatomy with dimensions, every variant, every state, tokens, props, do/don't, and a motion table naming each animation's reduced-motion behaviour. |
...
- **36 of 85 components have a full spec page.** The other 49 have source, a contract and a place on a
