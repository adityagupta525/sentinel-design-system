...
var __ds_out = (() => {
  ...
  function ArtifactCard({ state = "peek", eyebrow, title, children, provenance, onToggle, onWhy, onShare, onMenu, expandLabel = "Expand", collapseLabel = "Collapse" }) {
    ...
    )), /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", padding: "14px 14px 0", textAlign: "left", pointerEvents: "none" } }, /* @__PURE__ */ react_global_default.createElement(Eyebrow, null, eyebrow), /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-4)" } }, titleEl), /* @__PURE__ */ react_global_default.createElement("div", { style: { maxHeight: 96, marginTop: "var(--space-10)", overflow: "hidden", pointerEvents: "auto" } }, filling ? /* @__PURE__ */ react_global_default.createElement("div", { style: { height: 96, borderRadius: "var(--radius-12)", background: "var(--color-track)", animation: "sentinel-shimmer 1200ms ease-in-out infinite" } }) : children), provenance && /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: "10px 0 0", fontFamily: "var(--font-ui)", fontWeight: "var(--weight-regular)", fontSize: "var(--text-11)", lineHeight: "var(--leading-15)", color: "var(--color-muted)" } }, provenance))), (onToggle || onWhy || onShare) && /* @__PURE__ */ react_global_default.createElement(react_global_default.Fragment, null, /* @__PURE__ */ react_global_default.createElement("div", { style: { margin: "12px 14px 0", height: "var(--border-hairline)", background: "var(--color-line-soft)" } }), /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", padding: "0 14px" } }, /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: filling ? void 0 : toggle, style: slot }, toggle && !filling ? /* @__PURE__ */ react_global_default.createElement("span", { style: { display: "flex", alignItems: "center", gap: "var(--space-5)" } }, label(expanded ? collapseLabel : expandLabel, true), /* @__PURE__ */ react_global_default.createElement(Chevron, { up: expanded })) : null), /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: onWhy, style: slot }, onWhy ? label("Why?") : null), /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: onShare, style: slot }, onShare ? label("Share") : null))));
  }
  ...
  function MessageActions({ role = "assistant", actions, onAction }) {
    ...
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", gap: "var(--space-16)", justifyContent: role === "user" ? "flex-end" : "flex-start", margin: "-8px 0 -10px" } }, list.map((a) => /* @__PURE__ */ react_global_default.createElement(
      "button",
      {
        ...
        style: { appearance: "none", border: "none", background: "transparent", cursor: "pointer", display: "flex", alignItems: "center", minHeight: 44, padding: "12px 2px", font: "var(--type-meta-font)", color: "var(--color-muted)" }
      },
      LABELS[a] || a
    )));
  }
