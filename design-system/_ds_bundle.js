...
var __ds_out = (() => {
  ...
  function Composer({ value = "", onChange, onFocus, onSend, placeholder = "Ask Sentinel about a client, a fund, or a plan", autoFocus = false, streaming = false, onStop }) {
    ...
    ), /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-12)", display: "flex", alignItems: "center", justifyContent: "space-between", paddingRight: "var(--space-2)" } }, /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: 22, background: "var(--color-surface)", boxShadow: "0 0 0 1px var(--color-line)" } }, /* @__PURE__ */ react_global_default.createElement(IconAttach, null)), streaming ? /* @__PURE__ */ react_global_default.createElement("button", { type: "button", onClick: onStop, style: btn }, /* @__PURE__ */ react_global_default.createElement("span", { style: { width: 13, height: 13, borderRadius: 3, background: "var(--color-surface)" } })) : /* @__PURE__ */ react_global_default.createElement("button", { type: "button", onClick: () => canSend && onSend && onSend(), disabled: !canSend, style: { ...btn, opacity: canSend ? 1 : 0.4, cursor: canSend ? "pointer" : "default" } }, /* @__PURE__ */ react_global_default.createElement(IconArrow, null))));
  }
