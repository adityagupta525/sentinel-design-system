...
var __ds_out = (() => {
  ...
  // design-system/components/actions/StickyCTA.jsx
  function StickyCTA({ label, onClick }) {
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", zIndex: 10, padding: "6px 16px 8px", animation: "ds-rise var(--dur-screen) var(--ease) both", animationDelay: "320ms" } }, /* @__PURE__ */ react_global_default.createElement(DarkButton, { label, onClick }));
  }
  ...
  function ArtifactCard({ state = "peek", eyebrow, title, children, provenance, onToggle, onWhy, onShare, onMenu, expandLabel = "Expand", collapseLabel = "Collapse" }) {
    ...
    )), /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", padding: "14px 14px 0", textAlign: "left", pointerEvents: "none" } }, /* @__PURE__ */ react_global_default.createElement(Eyebrow, null, eyebrow), /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-4)" } }, titleEl), /* @__PURE__ */ react_global_default.createElement("div", { style: { height: 96, marginTop: "var(--space-10)", overflow: "hidden", pointerEvents: "auto" } }, filling ? /* @__PURE__ */ react_global_default.createElement("div", { style: { height: 96, borderRadius: "var(--radius-12)", background: "var(--color-track)", animation: "sentinel-shimmer 1200ms ease-in-out infinite" } }) : children), provenance && /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: "10px 0 0", fontFamily: "var(--font-ui)", fontWeight: "var(--weight-regular)", fontSize: "var(--text-11)", lineHeight: "var(--leading-15)", color: "var(--color-muted)" } }, provenance))), /* @__PURE__ */ react_global_default.createElement("div", { style: { margin: "12px 14px 0", height: "var(--border-hairline)", background: "var(--color-line-soft)" } }), /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", padding: "0 14px" } }, /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: filling ? void 0 : toggle, style: slot }, toggle && !filling ? /* @__PURE__ */ react_global_default.createElement("span", { style: { display: "flex", alignItems: "center", gap: "var(--space-5)" } }, label(expanded ? collapseLabel : expandLabel, true), /* @__PURE__ */ react_global_default.createElement(Chevron, { up: expanded })) : null), /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: onWhy, style: slot }, onWhy ? label("Why?") : null), /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: onShare, style: slot }, onShare ? label("Share") : null)));
  }
  ...
  function DataTableCard({ title, meta, description, columns, rows, footer, filters, bar, showAll, onShowAll }) {
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { width: "100%", borderRadius: "var(--radius-16)", background: "var(--color-surface)", boxShadow: "var(--shadow-card)", boxSizing: "border-box", padding: "var(--space-14)", animation: "ds-rise var(--dur-screen) var(--ease) both" } }, /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "var(--space-8)" } }, /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: 0, ...{ fontFamily: "var(--font-ui)", fontWeight: "var(--weight-medium)", fontSize: "var(--text-16)", lineHeight: "var(--leading-22)", color: "var(--color-ink)" } } }, title), meta && /* @__PURE__ */ react_global_default.createElement(Badge, null, meta)), description && /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: "6px 0 0", ...{ fontFamily: "var(--font-ui)", fontWeight: "var(--weight-regular)", fontSize: "var(--text-13)", lineHeight: "var(--leading-19)", color: "var(--color-muted)" } } }, description), filters && /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-10)" } }, filters), bar && /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-12)" } }, bar), /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-12)", display: "flex", alignItems: "center", gap: "var(--space-8)", borderBottom: "0.5px solid var(--color-line-soft)", paddingBottom: "var(--space-6)" } }, columns.map((c) => /* @__PURE__ */ react_global_default.createElement("div", { key: c.key, style: colStyle(c) }, /* @__PURE__ */ react_global_default.createElement(Eyebrow, null, c.header)))), rows.map((r, i) => /* @__PURE__ */ react_global_default.createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: "var(--space-8)", padding: "9px 0", borderBottom: i < rows.length - 1 ? "0.5px solid var(--color-line-soft)" : "none", animation: "ds-fade var(--dur-enter) var(--ease) both", animationDelay: `${i * 40}ms` } }, columns.map((c) => /* @__PURE__ */ react_global_default.createElement("div", { key: c.key, style: colStyle(c) }, r[c.key])))), footer && /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: "10px 0 0", ...{ fontFamily: "var(--font-ui)", fontWeight: "var(--weight-regular)", fontSize: "var(--text-12)", lineHeight: "var(--leading-17)", color: "var(--color-muted)" } } }, footer), showAll && /* @__PURE__ */ react_global_default.createElement("button", { type: "button", onClick: onShowAll, style: { appearance: "none", border: "none", cursor: "pointer", marginTop: "var(--space-10)", width: "100%", borderRadius: "var(--radius-12)", background: "var(--color-chip)", padding: "9px 0", boxShadow: "0 0 0 1px var(--color-line)" } }, /* @__PURE__ */ react_global_default.createElement("span", { style: { fontFamily: "var(--font-ui)", fontWeight: "var(--weight-bold)", fontSize: "var(--text-12)", color: "var(--color-bronze-deep)" } }, showAll)));
  }
  ...
  function ChartLine({ series = [], density = "expanded", tone = "ramp", target, width = 311, valueFormat = (v) => `${v}%`, xFormat = (x) => String(x), scrub = false, run = true, domain }) {
    ...
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { width: "100%" } }, scrub && !peek && /* @__PURE__ */ react_global_default.createElement("div", { style: { marginBottom: "var(--space-6)" } }, /* @__PURE__ */ react_global_default.createElement(ChartReadout, { label: active ? xFormat(active.x) : "", value: active ? valueFormat(active.y) : "", active: tip != null })), /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", display: "flex", alignItems: "flex-start", gap: 0 } }, /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", flex: 1, minWidth: 0, touchAction: "pan-y", paddingRight: padR }, onPointerDown: onMove, onPointerMove: (e) => tip != null && onMove(e), onPointerUp: () => setTip(null), onPointerLeave: () => setTip(null) }, /* @__PURE__ */ react_global_default.createElement("svg", { ref: svgRef, width: "100%", height: plot, viewBox: `0 0 ${w} ${plot}`, preserveAspectRatio: "none", style: { display: "block", overflow: "visible" } }, /* @__PURE__ */ react_global_default.createElement("style", null, "@keyframes ds-draw-on{to{stroke-dashoffset:0}}@media (prefers-reduced-motion:reduce){@keyframes ds-draw-on{from{stroke-dashoffset:0;opacity:0}to{stroke-dashoffset:0;opacity:1}}}"), target && /* @__PURE__ */ react_global_default.createElement("line", { x1: "0", x2: w, y1: y(target.value), y2: y(target.value), stroke: "var(--color-line)", strokeWidth: "1", strokeDasharray: "4 2", vectorEffect: "non-scaling-stroke" }), use.length === 1 && /* @__PURE__ */ react_global_default.createElement("path", { d: areaPath(pts(use[0]), plot - 1), fill: "var(--tint-bronze-06)" }), use.slice().reverse().map((s, ri) => {
      ...
      return /* @__PURE__ */ react_global_default.createElement("div", { key: s.label, style: { position: "absolute", right: 0, top, width: padR - 6, display: "flex", flexDirection: "column" } }, /* @__PURE__ */ react_global_default.createElement("span", { style: { ...tabular, fontFamily: FONT, fontWeight: "var(--weight-bold)", fontSize: peek ? 11.5 : 12, lineHeight: "var(--leading-15)", color: i === 1 ? "var(--color-data-deemph)" : "var(--color-bronze-deep)" } }, valueFormat(last.y)), !peek && /* @__PURE__ */ react_global_default.createElement("span", { style: { overflowWrap: "break-word", fontFamily: FONT, fontWeight: "var(--weight-medium)", fontSize: 10.5, lineHeight: "var(--leading-14)", color: i === 1 ? "var(--color-data-deemph)" : "var(--color-muted)" } }, s.label));
    }))), /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", height: labelBand, alignItems: "center", justifyContent: "space-between", gap: "var(--space-8)", paddingRight: padR } }, peek ? /* @__PURE__ */ react_global_default.createElement(react_global_default.Fragment, null, /* @__PURE__ */ react_global_default.createElement("span", { style: { fontFamily: FONT, fontWeight: "var(--weight-medium)", fontSize: "var(--text-11)", lineHeight: "var(--leading-14)", color: "var(--color-muted)" } }, use[0] ? xFormat(use[0].points[0].x) : ""), /* @__PURE__ */ react_global_default.createElement("span", { style: { fontFamily: FONT, fontWeight: "var(--weight-medium)", fontSize: "var(--text-11)", lineHeight: "var(--leading-14)", color: "var(--color-muted)" } }, use[0] ? xFormat(use[0].points[use[0].points.length - 1].x) : "")) : ticks(d0, d1, 2).slice(0, 2).map((t, i) => /* @__PURE__ */ react_global_default.createElement("span", { key: t, style: { ...tabular, fontFamily: FONT, fontWeight: "var(--weight-medium)", fontSize: "var(--text-11)", lineHeight: "var(--leading-14)", color: "var(--color-muted)" } }, i === 0 && use[0] ? xFormat(use[0].points[0].x) : use[0] ? xFormat(use[0].points[use[0].points.length - 1].x) : ""))));
  }
  ...
  function MessageActions({ role = "assistant", actions, onAction }) {
    ...
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", gap: "var(--space-16)", justifyContent: role === "user" ? "flex-end" : "flex-start", margin: "-8px 0 -10px" } }, list.map((a) => /* @__PURE__ */ react_global_default.createElement(
      "button",
      {
        key: a,
        type: "button",
        onClick: () => onAction && onAction(a),
        style: { appearance: "none", border: "none", background: "transparent", cursor: "pointer", display: "flex", alignItems: "center", minHeight: 44, padding: "12px 2px", fontFamily: "var(--font-ui)", fontWeight: "var(--weight-medium)", fontSize: 11.5, lineHeight: "var(--leading-16)", color: "var(--color-muted)" }
      },
      LABELS[a] || a
    )));
  }
  ...
  function ProgressTrace({ steps, stepMs = 850, reasoning, onDone, autoplay = true, initialActive = 0, seconds = 3 }) {
    const [active, setActive] = react_global_default.useState(initialActive);
    const [done, setDone] = react_global_default.useState(false);
    const [collapsed, setCollapsed] = react_global_default.useState(false);
  ...
  function Composer({ value = "", onChange, onFocus, onSend, placeholder = "Ask Sentinel about a client, a fund, or a plan", autoFocus = false, streaming = false, onStop }) {
    ...
    ), /* @__PURE__ */ react_global_default.createElement("style", null, ".ds-composer-input::placeholder{color:var(--color-muted)}"), /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-12)", display: "flex", alignItems: "center", justifyContent: "space-between", paddingRight: "var(--space-2)" } }, /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: 22, background: "var(--color-surface)", boxShadow: "0 0 0 1px var(--color-line)" } }, /* @__PURE__ */ react_global_default.createElement(IconAttach, null)), streaming ? /* @__PURE__ */ react_global_default.createElement("button", { type: "button", onClick: onStop, style: btn }, /* @__PURE__ */ react_global_default.createElement("span", { style: { width: 13, height: 13, borderRadius: 3, background: "var(--color-surface)" } })) : /* @__PURE__ */ react_global_default.createElement("button", { type: "button", onClick: () => canSend && onSend && onSend(), disabled: !canSend, style: { ...btn, opacity: canSend ? 1 : 0.4, cursor: canSend ? "pointer" : "default" } }, /* @__PURE__ */ react_global_default.createElement(IconArrow, null))));
  }
  ...
  function MoneyComposer({ onSend, placeholder = "or type an amount" }) {
    ...
    ), /* @__PURE__ */ react_global_default.createElement("style", null, ".ds-composer-input::placeholder{color:var(--color-muted)}")), /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-12)", display: "flex", justifyContent: "flex-end" } }, /* @__PURE__ */ react_global_default.createElement("button", { type: "button", disabled: !canSend, onClick: () => canSend && onSend && onSend("\u20B9" + formatted), style: { appearance: "none", border: "none", display: "flex", width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: "var(--radius-full)", background: "var(--gradient-dark-cta)", opacity: canSend ? 1 : 0.4, cursor: canSend ? "pointer" : "default", padding: 0 } }, /* @__PURE__ */ react_global_default.createElement(IconArrow, null))));
  }
  ...
  function Dumbbell({ label, target, actual, max = 100, targetLabel, actualLabel }) {
  ...
  function SearchField({ value = "", onChange, placeholder = "Search 512 clients", onClear, autoFocus = false }) {
    ...
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", alignItems: "center", gap: "var(--space-8)", width: "100%", height: 44, borderRadius: "var(--radius-20)", background: "var(--color-surface)", padding: "0 14px", boxSizing: "border-box", border: `1px solid ${focus ? "var(--color-bronze)" : "var(--color-line)"}`, boxShadow: focus ? "var(--focus-ring)" : "none", transition: "box-shadow var(--dur-press), border-color var(--dur-press)" } }, /* @__PURE__ */ react_global_default.createElement(
      ...
      "button",
      {
        ...
        style: { appearance: "none", border: "none", background: "transparent", cursor: "pointer", flexShrink: 0, display: "flex", alignItems: "center", minHeight: 44, padding: "0 2px", fontFamily: "var(--font-ui)", fontWeight: "var(--weight-medium)", fontSize: 11.5, lineHeight: "var(--leading-16)", color: "var(--color-muted)" }
      },
      "Clear"
    ) : null);
  }
  ...
  function List({ items, children, dividers = "inset", header, footer, groupBy = "none", emptyState, loading = false, rowProps }) {
    ...
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { width: "100%" } }, header && /* @__PURE__ */ react_global_default.createElement("div", { style: { padding: "0 0 6px" } }, /* @__PURE__ */ react_global_default.createElement(Eyebrow, null, header)), /* @__PURE__ */ react_global_default.createElement("div", { style: { borderRadius: "var(--radius-16)", background: "var(--color-surface)", boxShadow: "0 0 0 1px var(--color-line)", padding: "0 12px", boxSizing: "border-box" } }, isEmpty ? /* @__PURE__ */ react_global_default.createElement("div", { style: { padding: "18px 2px" } }, /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: 0, fontFamily: "var(--font-ui)", fontWeight: "var(--weight-medium)", fontSize: "var(--text-14)", lineHeight: "var(--leading-20)", color: "var(--color-ink)" } }, emptyState.title), emptyState.body && /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: "4px 0 0", fontFamily: "var(--font-ui)", fontWeight: "var(--weight-regular)", fontSize: "var(--text-12)", lineHeight: "var(--leading-17)", color: "var(--color-muted)" } }, emptyState.body), emptyState.action && /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "var(--space-12)" } }, emptyState.action)) : renderRows(), footer && !isEmpty && /* @__PURE__ */ react_global_default.createElement(react_global_default.Fragment, null, line(false), /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", minHeight: 44, alignItems: "center" } }, footer))));
  }
...
.ds-pressable[data-hit]::before{content:"";position:absolute;left:calc(-1 * var(--hit-x));right:calc(-1 * var(--hit-x));top:calc(-1 * var(--hit-y));bottom:calc(-1 * var(--hit-y))}`;
  ...
  function StatusSpacer() {
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", zIndex: 10, display: "flex", height: 44, width: "100%", flexShrink: 0, alignItems: "flex-end", justifyContent: "space-between", padding: "0 24px 6px", boxSizing: "border-box" } }, /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: 0, fontFamily: "var(--font-ui)", fontWeight: "var(--weight-semibold)", fontSize: "var(--text-13)", color: "var(--color-ink)" } }, "9:41"), /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", alignItems: "center", gap: "var(--space-5)" } }, /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", alignItems: "flex-end", gap: "var(--space-2)" } }, [6, 9, 12, 15].map((h) => /* @__PURE__ */ react_global_default.createElement("div", { key: h, style: { width: 3, height: h, borderRadius: 1, background: "var(--color-ink)" } }))), /* @__PURE__ */ react_global_default.createElement("svg", { width: "16", height: "12", viewBox: "0 0 16 12", fill: "none" }, /* @__PURE__ */ react_global_default.createElement("path", { d: "M8 2.5C10 2.5 11.8 3.3 13 4.6M8 6C9 6 9.9 6.4 10.5 7M5.5 9.3 8 11l2.5-1.7", stroke: "var(--color-ink)", strokeWidth: "1.3", strokeLinecap: "round" })), /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", height: 11, width: 22 } }, /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "absolute", inset: 0, borderRadius: 3, border: "1px solid var(--color-ink)", opacity: 0.4, boxSizing: "border-box" } }), /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "absolute", top: 1.5, bottom: 1.5, left: 1.5, right: 5, borderRadius: 1, background: "var(--color-ink)" } }))));
  }

  // design-system/components/shell/TopBar.jsx
  function TopBar({ onMenu, onNew, title = "Sentinel" }) {
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", zIndex: 10, display: "flex", height: 44, width: "100%", flexShrink: 0, alignItems: "center", justifyContent: "space-between", padding: "0 16px", boxSizing: "border-box" } }, /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: onMenu, style: { display: "flex", width: 40, height: 40, alignItems: "center", justifyContent: "center", borderRadius: "var(--radius-full)" } }, /* @__PURE__ */ react_global_default.createElement(IconMenu, null)), /* @__PURE__ */ react_global_default.createElement("div", { style: { borderRadius: "var(--radius-full)", background: "var(--color-surface)", padding: "12px 16px", boxShadow: "var(--shadow-card), 0 0 0 1px var(--color-line)" } }, /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: 0, fontFamily: "var(--font-ui)", fontWeight: "var(--weight-semibold)", fontSize: "var(--text-14)", lineHeight: 1, textAlign: "center", color: "var(--color-ink)" } }, title)), /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: onNew, style: { display: "flex", width: 44, height: 44, alignItems: "center", justifyContent: "center", borderRadius: "var(--radius-full)" } }, /* @__PURE__ */ react_global_default.createElement(IconPlus, null)));
  }
