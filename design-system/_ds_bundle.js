...
var __ds_out = (() => {
  ...
  // design-system/components/actions/DecisionsStrip.jsx
  function DecisionsStrip({ tokens }) {
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { display: "flex", width: "100%", alignItems: "center", gap: "var(--space-8)", overflowX: "auto", borderRadius: "var(--radius-16)", background: "var(--color-surface)", padding: "10px 12px", boxShadow: "0 0 0 1px var(--color-line)", scrollbarWidth: "none", boxSizing: "border-box" } }, tokens.map((t, i) => /* @__PURE__ */ react_global_default.createElement("div", { key: t.label, style: { display: "flex", flexShrink: 0, alignItems: "center", gap: "var(--space-8)" } }, i > 0 && /* @__PURE__ */ react_global_default.createElement("div", { style: { height: 14, width: 1, background: "var(--color-line)" } }), /* @__PURE__ */ react_global_default.createElement("button", { type: "button", onClick: t.onClick, style: { appearance: "none", border: "none", cursor: "pointer", flexShrink: 0, borderRadius: "var(--radius-full)", background: "var(--color-chip)", padding: "5px 10px", boxShadow: "0 0 0 1px var(--color-line)" } }, /* @__PURE__ */ react_global_default.createElement("span", { style: { whiteSpace: "nowrap", fontFamily: "var(--font-ui)", fontWeight: "var(--weight-bold)", fontSize: "var(--text-12)", color: "var(--color-bronze-deep)" } }, t.label)))));
  }
  ...
  // design-system/components/shell/CanvasHeader.jsx
  function CanvasHeader({ title, onBack, onMenu, backLabel = "Back to chat" }) {
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", zIndex: 10, display: "flex", height: 44, width: "100%", flexShrink: 0, alignItems: "center", justifyContent: "space-between", padding: "0 16px", boxSizing: "border-box" } }, /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: onBack, style: { display: "flex", alignItems: "center", gap: "var(--space-4)", borderRadius: "var(--radius-full)", background: "var(--color-surface)", padding: "8px 12px", boxShadow: "0 0 0 1px var(--color-line)" } }, /* @__PURE__ */ react_global_default.createElement("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none" }, /* @__PURE__ */ react_global_default.createElement("path", { d: "M7.5 3 4.5 6l3 3", stroke: "var(--color-bronze-deep)", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round" })), /* @__PURE__ */ react_global_default.createElement("span", { style: { fontFamily: "var(--font-ui)", fontWeight: "var(--weight-semibold)", fontSize: "var(--text-12)", lineHeight: 1, color: "var(--color-bronze-deep)" } }, backLabel)), /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: 0, position: "absolute", left: "50%", transform: "translateX(-50%)", fontFamily: "var(--font-ui)", fontWeight: "var(--weight-semibold)", fontSize: "var(--text-14)", color: "var(--color-ink)" } }, title), /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick: onMenu, style: { display: "flex", width: 40, height: 40, alignItems: "center", justifyContent: "center", borderRadius: "var(--radius-full)" } }, /* @__PURE__ */ react_global_default.createElement("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none" }, /* @__PURE__ */ react_global_default.createElement("circle", { cx: "4", cy: "10", r: "1.4", fill: "var(--color-ink)" }), /* @__PURE__ */ react_global_default.createElement("circle", { cx: "10", cy: "10", r: "1.4", fill: "var(--color-ink)" }), /* @__PURE__ */ react_global_default.createElement("circle", { cx: "16", cy: "10", r: "1.4", fill: "var(--color-ink)" }))));
  }
...
.ds-pressable[data-hit]::before{content:"";position:absolute;left:calc(-1 * var(--hit-x));right:calc(-1 * var(--hit-x));top:calc(-1 * var(--hit-y));bottom:calc(-1 * var(--hit-y))}`;
  ...
  function ScreenScaffold({
    ...
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "relative", display: "flex", height: "100%", width: "100%", flexDirection: "column" } }, /* @__PURE__ */ react_global_default.createElement(ScreenBackdrop, null), /* @__PURE__ */ react_global_default.createElement(StatusSpacer, { time }), /* @__PURE__ */ react_global_default.createElement(TopBar, { title, onMenu: onMenu || (() => {
      ...
      /* @__PURE__ */ react_global_default.createElement("div", { ref: scrollRef || own, style: { position: "relative", zIndex: 1, display: "flex", flex: 1, flexDirection: "column", overflowY: "auto", minHeight: 0 } }, /* @__PURE__ */ react_global_default.createElement("div", { style: { marginTop: "auto", display: "flex", flexDirection: "column", gap: "var(--stack)", padding: "16px var(--gutter) 24px" } }, children))
    ) : (
    ...
    ), /* @__PURE__ */ react_global_default.createElement(Dock, { chips, composer }), /* @__PURE__ */ react_global_default.createElement(HomeIndicator, null));
  }
  ...
  function ScrollToBottomButton({ show, onClick }) {
    return /* @__PURE__ */ react_global_default.createElement("div", { style: { position: "absolute", bottom: 8, left: "50%", zIndex: 20, transform: show ? "translateX(-50%)" : "translate(-50%, 8px)", opacity: show ? 1 : 0, pointerEvents: show ? "auto" : "none", transition: "opacity var(--dur-fast) var(--ease), transform var(--dur-fast) var(--ease)" } }, /* @__PURE__ */ react_global_default.createElement(Pressable, { onClick, style: { display: "flex", width: 36, height: 36, alignItems: "center", justifyContent: "center", borderRadius: "var(--radius-full)", background: "var(--color-surface)", boxShadow: "var(--shadow-float), 0 0 0 1px var(--color-line)" } }, /* @__PURE__ */ react_global_default.createElement("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none" }, /* @__PURE__ */ react_global_default.createElement("path", { d: "M8 3v9M4 8l4 4 4-4", stroke: "var(--color-bronze-deep)", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round" }))));
  }

  // design-system/components/text/DemoFooter.jsx
  function DemoFooter({ text = "Demo data \u2014 Meera Nair is an example. No real portfolio is shown." }) {
    return /* @__PURE__ */ react_global_default.createElement("p", { style: { margin: 0, width: "100%", textAlign: "center", fontFamily: "var(--font-ui)", fontWeight: "var(--weight-regular)", fontSize: "var(--text-11)", lineHeight: "var(--leading-16)", color: "var(--color-muted)" } }, text);
  }
